...
// // 📍 อัปเดตข้อมูลสนามบินให้ตรงกับ Database ใหม่ล่าสุด (เพิ่ม DMK, CNX, HKT, KBV)
// const airports = [
//   { id: 1, code: 'HDY', name: 'หาดใหญ่ (HDY)' },
//   { id: 2, code: 'BKK', name: 'สุวรรณภูมิ (BKK)' },
//   { id: 3, code: 'DMK', name: 'ดอนเมือง (DMK)' },
//   { id: 4, code: 'CNX', name: 'เชียงใหม่ (CNX)' },
//   { id: 5, code: 'HKT', name: 'ภูเก็ต (HKT)' },
//   { id: 6, code: 'KBV', name: 'กระบี่ (KBV)' }
// ];

// // จำลองข้อมูลชั้นโดยสารให้ตรงกับ Database
// const flightClasses = [
//   { id: 1, name: 'ชั้นประหยัด (Economy)' },
//   { id: 2, name: 'ชั้นธุรกิจ (Business)' }
// ];
...
// function SearchWidget({ onSearch }) {
//   // สร้าง State สำหรับเก็บค่าที่ผู้ใช้เลือก
//   const [searchData, setSearchData] = useState({
//     tripType: 'oneway', 
//     origin: 'DMK', // ลองเปลี่ยนค่าเริ่มต้นเป็น DMK (ดอนเมือง) ดูครับ
//     destination: 'CNX', // เปลี่ยนปลายทางเริ่มต้นเป็น CNX (เชียงใหม่)
//     travelDate: '',
//     passengers: 1,
//     flightClass: 1 
//   });
...
//   const handleSearchClick = () => {
//     // ส่งข้อมูลที่ผู้ใช้เลือกกลับไปให้หน้าหลัก (App.jsx หรือ HomePage.jsx)
//     onSearch(searchData);
//   };

//   return (
//     <Paper elevation={3} sx={{ p: 3, borderRadius: 2, maxWidth: 1000, mx: 'auto', mt: 4 }}>
//       {/* ส่วนเลือกประเภทการเดินทาง */}
//       <Box sx={{ mb: 2, display: 'flex', alignItems: 'center' }}>
//         <RadioGroup
//           row
//           name="tripType"
